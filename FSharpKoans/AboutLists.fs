...
module ``about lists`` =
    ...
    (* A: :: performs better - it creates a single cons cell and references another list as the tail of the cell.
       @ copies the list contents, appending an element to them *)
